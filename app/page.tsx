  ...
  return (
    <div className="relative min-h-dvh overflow-hidden bg-[#edf6ff] px-6 py-10">
      ...
      <div className="relative mx-auto flex min-h-[calc(100dvh-5rem)] max-w-xl flex-col items-center justify-center rounded-[2rem] border border-blue-100 bg-white px-7 py-10 text-center shadow-sm">
        <div className="flex h-48 w-48 items-center justify-center rounded-full bg-[#f5faff] md:h-56 md:w-56">
          <Image
            src="/logo.png"
            alt="SAFE 프로젝트 로고"
            width={180}
        ...
        <div className="mt-10 w-full max-w-sm space-y-3">
          <Link
            href="/student/join"
            className="flex w-full items-center justify-center gap-3 rounded-[1.5rem] bg-blue-500 px-6 py-5 text-xl text-white transition hover:bg-blue-600"
          >
          ...
          <Link
            href="/teacher/login"
            className="flex w-full items-center justify-center gap-3 rounded-[1.5rem] bg-[#e7f1ff] px-6 py-5 text-xl text-blue-700 transition hover:bg-[#d8e8ff]"
          >
            <span className="text-2xl">👩‍🏫</span>
            교사 로그인
          </Link>
